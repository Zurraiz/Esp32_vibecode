...
const BUTTON_INSIGHTS = [
  ...
  'The reading is stored in a variable your program can use anytime.',
];
...
export default function SignalAnalyzerSimulator() {
  ...
  const handlePress = () => {
    ...
    if (pressCountRef.current >= 4) setInsightIndex(3);
  };
  ...
  const latestVal = signalHistory[0] ?? 0;
    ...
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="rounded-xl bg-white border border-gray-200 p-4 shadow-sm">
        ...
        <p className="text-xs text-gray-500">
          Press and hold the button. Watch the ESP32 read the
          signal in real time and store it as a value.
        </p>
      </div>
      ...
      <div className="rounded-xl bg-white border border-gray-200 shadow-sm
        ...
        <div className="bg-gray-900 p-3 h-24 flex gap-0.5 items-end">
