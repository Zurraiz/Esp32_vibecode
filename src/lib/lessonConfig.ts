...
export const LEVELS: Level[] = [
  ...
  {
    id: 3,
    title: 'Sensing & Output Intensity',
    description: 'Read analog sensors and control output intensity with PWM.',
    icon: '📡',
    isLocked: false,
    lessons: [
      {
        ...
        description: 'Use analog sensors to read continuously changing real-world data',
        icon: '📊',
        estimatedMinutes: 20,
        steps: [
          {
            ...
            type: 'content',
            title: 'Introduction',
            description: 'From digital states to continuous values',
          ...
          },
          {
            ...
            type: 'concept',
            title: 'Concept Building',
            description: 'Analog sensors, value ranges, and continuous change',
            pdfUrl: '/pdfs/level-3/lesson-3-1/concept-building.pdf',
          },
          {
            id: 'challenge',
            type: 'challenge',
            title: 'Student Task',
            description: 'Read two sensors and display their values on Serial Monitor',
            allowedBlocks: ['analog_read', 'serial_begin', 'serial_print', 'serial_printvar', 'delay_ms', 'delay_sec'],
            challengeBlocks: ['analog_read', 'serial_begin', 'serial_printvar', 'delay_ms'],
            challengeStrict: false,
            simulationId: 'dual-sensor',
            showSerialOutput: true,
            hint: 'Read analog pin into a variable, start Serial, then print that variable — use two analog_read blocks for two sensors',
          },
          {
            id: 'mapping',
            type: 'mapping',
            title: 'Arduino Mapping',
            description: 'See how analog reading becomes real C++ code',
      ...
      },
      {
        ...
        description: 'Combine sensors, mapping and PWM into a complete control system',
        icon: '⚡',
        estimatedMinutes: 25,
        steps: [
          {
            ...
            type: 'content',
            title: 'Introduction',
            description: 'Manual vs automatic control in real systems',
            pdfUrl: '/pdfs/level-3/lesson-3-4/introduction.pdf',
          },
          {
            id: 'explore',
            type: 'explore',
            title: 'Exploration',
            description: 'Compare manual and automatic control modes',
          ...
          },
          {
            ...
            type: 'concept',
            title: 'Concept Building',
            description: 'Dual-mode systems, control priority, and real-time loops',
            pdfUrl: '/pdfs/level-3/lesson-3-4/concept-building.pdf',
          },
          {
            id: 'challenge',
            type: 'challenge',
            title: 'Student Task',
            description: 'Build a dual-mode sensor-controlled brightness system',
            allowedBlocks: ['analog_read', 'map_val', 'pwm_setup', 'pwm_write', 'if_block', 'else_block', 'end_if'],
            challengeBlocks: ['analog_read', 'map_val', 'pwm_write'],
            challengeStrict: false,
            simulationId: 'dual-mode',
            hint: 'Read a sensor into a variable, map it to 0-255, then write it to PWM. Add a second analog_read + map_val pair for the second sensor if attempting the dual-mode challenge.',
          },
          {
            id: 'mapping',
            type: 'mapping',
            title: 'Arduino Mapping',
            description: 'See how a complete dual-mode control system looks in code',
